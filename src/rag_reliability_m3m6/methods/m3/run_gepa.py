...
DSPy используется ТОЛЬКО для оптимизации; инференс — rag_reliability_m3m6.methods.m3.predict
...
Запуск:
  ...
  python scripts/m3m6/run_gepa.py --config configs/config.cloud.yaml --variant plain --seed 1 \
...
from rag_reliability_m3m6.common.run_meta import git_hash
