...
поверх `rag_reliability.common.results_index.build_index`; в отрисовке ничего
«на глаз» не считается.
Тяжёлый plotly импортируется лениво внутри main.

Запуск:
  python scripts/make_report.py --root . --out artifacts/report/index.html [--splits val test]
"""
...
from rag_reliability.analysis.figs import KIND_ORDER, f1_threshold_curve, reliability_bins
from rag_reliability.common.results_index import ResultsIndex, build_index
