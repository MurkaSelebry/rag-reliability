...
Запуск:
  python scripts/eda_alfa.py --config configs/config.yaml [--limit N] [--out ...]
"""
...
from rag_reliability.data.alfa_loader import load_alfa
from rag_reliability.data.make_splits import group_key
