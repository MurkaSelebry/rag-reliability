...
Запуск:
  ...
  python scripts/gepa_report.py --stats artifacts/cloud/m3_gepa_stats_markers_seed0.json
"""
...
def main() -> None:
    ...
    if not stats_path.exists():
        raise SystemExit(
            f"нет файла статистики: {stats_path} (сначала запусти scripts/run_gepa.py)"
        )
