...
Запуск: `streamlit run scripts/m3m6/explorer.py`
Читает ТОЛЬКО `rag_reliability_m3m6.common.results_index.build_index()` (+ сырые файлы кейсов
...
def _load(root: str = "."):
    ...
    from rag_reliability_m3m6.common.results_index import build_index
