...
`rag_reliability_m3m6.common.eval_local`). Пороги: либо явные --t-faith/--t-rel,
...
Запуск:
  ...
  python scripts/m3m6/evaluate.py --cases data/processed/pseudo_dev_test.jsonl \
...
from rag_reliability_m3m6.common.schemas import Pred, load_cases
