#!/usr/bin/env python
"""Prepare SFT training files for the DIRECT judge and print the mlx_lm.lora command.
...
Example:
    python scripts/train_direct_lora.py --data data/dummy.jsonl --config configs/direct_lora.yaml
"""
