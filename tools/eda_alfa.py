...
Запуск:
  python -m tools.eda_alfa --config configs/config.yaml [--limit N] [--out ...]
"""
...
from src.common.schemas import Case, load_cases
from src.data.alfa_loader import load_alfa
from src.data.make_splits import group_key
